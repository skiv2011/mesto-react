  ...
  return (
    <PopupWithForm
      ...
      <fieldset className="popup__field">
        <input type="text" className="popup__decription popup__decription_type_title" name="name" id="input-title"
          placeholder="Название" value={title || ''} onChange={handleChangeName} minLength="2" maxLength="30" required />
